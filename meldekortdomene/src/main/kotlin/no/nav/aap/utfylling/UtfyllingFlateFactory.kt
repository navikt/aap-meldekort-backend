...
interface UtfyllingFlateFactory {
    fun flateForBruker(ident: Ident, repositoryProvider: RepositoryProvider, gatewayProvider: GatewayProvider, connection: DBConnection): Pair<String, UtfyllingFlate>
}

class UtfyllingFlateFactoryImpl(private val clock: Clock) : UtfyllingFlateFactory {
    val log = LoggerFactory.getLogger(javaClass)

    override fun flateForBruker(ident: Ident, repositoryProvider: RepositoryProvider, gatewayProvider: GatewayProvider, connection: DBConnection): Pair<String, UtfyllingFlate> {
