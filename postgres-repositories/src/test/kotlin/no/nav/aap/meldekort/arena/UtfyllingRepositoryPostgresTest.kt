...
class UtfyllingRepositoryPostgresTest {
    ...
    @Test
    fun lastSkjema() {
        val repo = UtfyllingRepositoryPostgres(InitTestDatabase.dataSource)
    ...
    fun `lagre og hent skjema`() {
        ...
        val endretSkjema = utfylling.copy(skjema = utfylling.skjema.copy(tilstand = SkjemaTilstand.FORSØKER_Å_SENDE_TIL_ARENA))
