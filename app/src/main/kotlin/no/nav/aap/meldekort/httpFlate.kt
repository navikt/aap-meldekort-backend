...
import no.nav.aap.statistikk.PubliserMetrikkerJobbUtfører
            ...
            authenticate(IdentityProvider.TOKENX.value) {
                apiRouting {
                    route("api") {
                        ...
                        meldekortStatus(dataSource, repositoryRegistry, clock, GatewayProvider)
                    }
                }
            }
...
private fun Application.startMotor(
    ...
    val motor = Motor(
        ...
        jobber = listOf(
            ...
            PubliserMetrikkerJobbUtfører.jobbKonstruktør(repositoryRegistry, prometheus),
        ),
        prometheus = prometheus,
    )
